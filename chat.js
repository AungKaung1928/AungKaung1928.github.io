...
const TOPICS = [
    ...
    },
    {
        ...
        a: "Four current projects, all robot learning on a CPU, and four earlier ones they grew out of.\n\n" +
           ...
           "3. SO-ARM100 Manipulation with RL, Imitation and Language — MuJoCo, PyTorch, LeRobot. One bench, three ways to learn the same arm; 127 tests, bench reference and RL measured (randomised fine-tune halves the held-out drop, mostly on latency), imitation and language tables not yet measured.\n" +
        ...
        deep: "Four current projects and four earlier ones. All of the current work is robot learning, trained and measured on CPU only.\n\n" +
           ...
           "- 127 tests green; the expert reference is measured (0.93 lift, 0.73 on the small cube); RL is measured on one seed (held-out drop 0.120 to 0.056 with a randomised fine-tune, almost all on action latency); imitation and language are not yet measured, as the page says\n" +
    ...
    },
    {
        ...
        a: "## Published on this page\n" +
           ...
           "- 127 tests green across four repositories, the expert reference and the RL transfer table measured (one seed), imitation and language marked not yet measured — SO-ARM100 Manipulation\n\n" +
           "## Not published\n" +
    ...
    },
    {
        ...
        deep: "## The gaps, plainly\n" +
           ...
           "- One of the four current cards is ahead of its numbers: the SO-ARM100 imitation and language tables are marked not yet measured (the bench reference and the RL table are, the RL one on a single training seed). The Microduck policies are the first half of their schedule on one seed; its domain-randomisation result is measured and negative\n" +
